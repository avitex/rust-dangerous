    ...
    I: Input<'i>,
{
    ...
    {
        self.try_advance(|input| input.try_split_consumed_op(consumer, CoreOperation::TakeConsumed))
    }
    ...
    where
        ...
        E: From<ExpectedValid<'i>>,
    {
        self.try_advance(|input| input.split_expect_op(f, expected, CoreOperation::Expect))
    }
    ...
    {
        self.try_advance(|input| input.try_split_expect_op(f, expected, CoreOperation::Expect))
    }
    ...
    {
        self.try_advance(|input| {
            input.try_split_expect_external_op(f, expected, CoreOperation::ExpectExternal)
        })
    }
    ...
    where
        E: From<ExpectedLength<'i>>,
    {
        self.try_advance(|input| input.split_at_op(len, CoreOperation::Skip))
            .map(drop)
    }
    ...
    {
        self.try_advance(|input| input.try_split_while_op(pred, CoreOperation::SkipWhile))
            .map(drop)
    }
    ...
    {
        self.try_advance(|input| input.split_until_op(pattern, CoreOperation::SkipUntil))
            .map(drop)
    }
    ...
    {
        self.try_advance(|input| {
            input.split_until_consume_op(pattern, CoreOperation::SkipUntilConsume)
        })
        .map(drop)
    }
    ...
    where
        E: From<ExpectedLength<'i>>,
    {
        self.try_advance(|input| input.split_at_op(len, CoreOperation::Take))
    }
    ...
    where
        ...
        F: FnMut(I::Token) -> Result<bool, E>,
    {
        self.try_advance(|input| input.try_split_while_op(pred, CoreOperation::TakeWhile))
    }
    ...
    where
        ...
        P: Pattern<I> + Into<Value<'i>> + Copy,
    {
        self.try_advance(|input| input.split_until_op(pattern, CoreOperation::TakeUntil))
    }
    ...
    {
        self.try_advance(|input| {
            input.split_until_consume_op(pattern, CoreOperation::TakeUntilConsume)
        })
    }
    ...
    where
        E: From<ExpectedLength<'i>>,
    {
        match self.input.clone().split_at_op(len, CoreOperation::Peek) {
    ...
    {
        self.try_advance(|input| input.split_prefix_op(prefix, CoreOperation::Consume))
            .map(drop)
    }
